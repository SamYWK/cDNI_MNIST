...
def cDNI(X_train, X_test, y_train, y_test):
    ...
    #synthetic gradients
    s_W1 = tf.Variable(tf.zeros([276, 256]))
    s_b1 = tf.Variable(tf.zeros([256]))
    s_z1 = tf.matmul(tf.concat([a1, W6_gradients, y_placeholder], 1), s_W1) + s_b1
    
    s_W2 = tf.Variable(tf.zeros([276, 256]))
    s_b2 = tf.Variable(tf.zeros([256]))
    s_z2 = tf.matmul(tf.concat([a2, W6_gradients, y_placeholder], 1), s_W2) + s_b2
    
    s_W3 = tf.Variable(tf.zeros([276, 256]))
    s_b3 = tf.Variable(tf.zeros([256]))
    s_z3 = tf.matmul(tf.concat([a3, W6_gradients, y_placeholder], 1), s_W3) + s_b3
    
    s_W4 = tf.Variable(tf.zeros([276, 256]))
    s_b4 = tf.Variable(tf.zeros([256]))
    s_z4 = tf.matmul(tf.concat([a4, W6_gradients, y_placeholder], 1), s_W4) + s_b4
    
    s_W5 = tf.Variable(tf.zeros([276, 256]))
    s_b5 = tf.Variable(tf.zeros([256]))
    s_z5 = tf.matmul(tf.concat([a5, W6_gradients, y_placeholder], 1), s_W5) + s_b5
    ...
    s_W5_delta = tf.reshape(tf.gradients(ys = l5_s_error, xs = s_W5), [276, 256])
    ...
    s_W4_delta = tf.reshape(tf.gradients(ys = l4_s_error, xs = s_W4), [276, 256])
    ...
    s_W3_delta = tf.reshape(tf.gradients(ys = l3_s_error, xs = s_W3), [276, 256])
    ...
    s_W2_delta = tf.reshape(tf.gradients(ys = l2_s_error, xs = s_W2), [276, 256])
    ...
    s_W1_delta = tf.reshape(tf.gradients(ys = l1_s_error, xs = s_W1), [276, 256])
